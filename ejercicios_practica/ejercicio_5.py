...
# ya elaborada
def generar_invitados(num_inv):
    cant_invitado = 0
    lista_invitados = []
    
    while(cant_invitado < num_inv):
...
if __name__ == '__main__':
    ...
    max_invitados = int(input('Ingrese cantidad maxima de invitados\n'))
    lista_invitados = generar_invitados(max_invitados)
    ...
    print('Lista de invitados ordenada: {}'.format(lista_invidatos_ordenada))
    print("terminamos")
